...
export default function Contact() {
    ...
    const handleSubmit = useCallback(
        async (e) => {
            ...
            try {
                const response = await fetch("https://formspree.io/f/xwpnjolr", {
                    method: "POST",
                    body: data,
                    headers: {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <div className="bg-white p-8 rounded-lg shadow-md">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <button type="submit" className="w-full bg-blue-600 text-white font-bold py-3 px-6 rounded-full hover:bg-blue-700 transition-colors duration-300">
                                Submit
                            </button>
                    ...
                    <div className="bg-white p-8 rounded-lg shadow-md">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <p>No. 3, Jalan PJU 10/10E, Saujana Damansara, 47810 Petaling Jaya, Selangor</p>
                            </div>
                            <div>
                                <h3 className="font-semibold">Phone</h3>
                                <p><a href="tel:+60127196133" className="text-blue-600 hover:underline">012-719 6133</a></p>
                            </div>
                            <div>
                                <h3 className="font-semibold">Email</h3>
                                <p><a href="mailto:mbauto.servicecentre@gmail.com" className="text-blue-600 hover:underline">mbauto.servicecentre@gmail.com</a></p>
                            </div>
                            <div>
