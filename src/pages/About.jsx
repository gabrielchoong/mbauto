    ...
    return (
        <div className="bg-gray-100">
            ...
            <div
                ...
                style={{ backgroundImage: "url('../../img/store-front.png')" }}
            >
                <div className="absolute inset-0 bg-black bg-opacity-60 flex flex-col justify-center items-center text-white text-center px-4">
                    ...
                    <p className="text-xl mt-4 max-w-2xl">
                        Your trusted partner in vehicle maintenance and repair
                        since 2024.
                    </p>
                </div>
            </div>
            ...
            <div className="container mx-auto px-4 py-16">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                        Founded in 2024, MB Auto Service Centre was born out of
                        a passion for cars and a desire to provide honest,
                        reliable, and high-quality automotive services to the
                        community. We started as a small workshop with a big
                        dream: to become the most trusted name in vehicle care
                        in Petaling Jaya. Today, we've grown our team and our
                        capabilities, but our core mission remains the same: to
                        treat every car as if it were our own and every customer
                        like family.
                    </p>
                </div>
            </div>
            ...
            <div className="container mx-auto px-4 py-16">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                        At MB Auto, we are committed to more than just fixing
                        cars. We are committed to earning your trust. This means
                        providing transparent pricing, clear communication, and
                        expert workmanship on every job. We use only
                        high-quality parts and stand behind our work, ensuring
                        your vehicle is safe, reliable, and ready for the road
                        ahead. Your satisfaction is our top priority.
                    </p>
                </div>
            </div>
        </div>
