        ...
        <div>
            ...
            <div className="relative bg-gray-100">
                <div
                    ...
                    style={{ backgroundImage: "url('../../img/store-interior.png')" }}
                >
                    <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center">
                        <h1 className="text-5xl font-bold">MB AUTO SERVICE CENTRE</h1>
                        <p className="text-xl mt-4">
                            Your One-Stop Shop for Vehicle Maintenance
                        </p>
                        <Link to="/contact">
                            <button className="mt-8 px-6 py-3 bg-blue-600 hover:bg-blue-700 rounded-full text-lg font-semibold">
                                Book an Appointment
                            </button>
                        </Link>
                    </div>
            ...
            <div className="container mx-auto px-4 mt-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {services.map((service) => (
                        <Link to={`/services/${service.id}`} key={service.id} className="block bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                        <div>
                            ...
                            <p>Our team of certified mechanics has years of experience.</p>
                        </div>
                        <div>
